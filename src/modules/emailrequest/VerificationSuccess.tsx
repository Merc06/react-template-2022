...
const VerificationSuccess = () => {
  ...
  <div className="flex flex-col pt-12 px-6 items-center">
    <h1 className="text-gray-800 text-2xl font-bold text-center">Your account is now <br /> verified</h1>
    ...
    <input type="text" placeholder="Password" className="border border-gray-700 rounded-lg mt-5 p-2 focus:outline-none w-64 text-xs" />
