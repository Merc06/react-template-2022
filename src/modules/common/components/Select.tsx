...
const Select = ({
  ...
  <select
    ...
    value={value}
    onChange={onChange}
    className={`${disabled && 'bg-gray-50'} transition text-xs duration-300 ease-in-out w-full px-4 py-2 border border-gray-500 rounded-lg overflow-hidden focus-within:border-accent focus:outline-none bg-none`}
    data-testid={testid}
  >
    {hasDefaultOption && (
