            ...
            { gigList.filter((item, index) => index < currentView).map((item, key) => (
                ...
                >
                    ...
                    <div className="py-2 px-3 space-y-2">
                        ...
                        <p className="text-xxs text-gray-700 line-clamp-3">
                    ...
                    <div className="flex justify-between items-center border-t border-gray-400 p-2 mt-auto">
                        <HeartIcon className="text-xs" />
                        <div className="flex items-center">
                            <div className="text-xxs text-gray-400 uppercase flex">
                                Starts at {getLowestPrice(item.pricing)} <DIcon className="text-xs mx-1"/> DOK
                            </div>
                        </div>
                    </div>
                </div>
